...
void loop() {
  ...
  Wire.write(0x3B); // start counting from ACCEL_XOUT_H
  ...
  temp_raw = Wire.read()<<8 | Wire.read(); //read registers 0x41 & 0x42  //Format issues or gyro will be shifted into temp
